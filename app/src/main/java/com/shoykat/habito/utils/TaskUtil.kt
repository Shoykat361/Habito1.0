package com.shoykat.habito.utils

import android.content.Context
import com.google.type.DateTime
import com.shoykat.habito.models.ChartDataModel
import com.shoykat.habito.models.DateStatusModel
import com.shoykat.habito.models.HabitWithTaskLogs
...
class TaskUtil {
    companion object {
        ...
        fun hasTaskLogForDate(habitWithTaskLogs: HabitWithTaskLogs, timestamp : Long) : Boolean {
            ...
            val startTime = org.joda.time.DateTime(timestamp).withTimeAtStartOfDay()
        ...
        fun getDateStatusModelsForHabit(context: Context, habitWithTaskLogs: HabitWithTaskLogs, fromDate : DateTime, days : Int) : Array<DateStatusModel> {
            ...
            for(i in array.indices) {
                ...
                val startTime = org.joda.time.DateTime(date).withTimeAtStartOfDay()
                val endTime = startTime.plusDays(1)
                val startTimeMillis = startTime.millis
                val endTimeMillis = endTime.millis
